          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg font-medium text-luxury-charcoal">
                Elevate your lifestyle with the Live Bold Health Adventure Concierge. As a yearly member, you'll gain access to advanced <strong className="text-brand-blue">VO₂ Max testing</strong>, <strong className="text-brand-blue">personalized fitness and meal planning</strong>, <strong className="text-brand-blue">coaching</strong>, and <strong className="text-brand-blue">luxury adventure retreats</strong> that unite health optimization with unforgettable experiences. Designed for busy families and executives, our program delivers <strong className="text-brand-blue">total wellness and lifestyle transformation</strong> — blending science, adventure, and concierge-level support. Join an exclusive community committed to living bolder, healthier, and longer lives.
              </p>
            </div>
