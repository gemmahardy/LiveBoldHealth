          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg font-medium text-luxury-charcoal">
                Transform your family's health journey with our exclusive concierge community. We'll guide you through <strong className="text-brand-blue">advanced VO₂ Max testing</strong> to understand your unique fitness profile, create <strong className="text-brand-blue">personalized fitness and meal plans</strong> that actually fit your busy schedule, and provide <strong className="text-brand-blue">one-on-one coaching</strong> to keep you motivated and on track. Plus, you'll experience <strong className="text-brand-blue">luxury adventure retreats</strong> in breathtaking locations like Maine's coast and Bali, where health optimization meets unforgettable family memories. We handle all the details so you can focus on what matters most — living your boldest, healthiest life. Let us be your partners in creating lasting <strong className="text-brand-blue">wellness transformation</strong> for you and your loved ones.
              </p>
            </div>
