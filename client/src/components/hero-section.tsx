          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg font-medium text-luxury-charcoal">
                Live Bold Health Adventure Concierge — where luxury wellness meets extraordinary experiences. A yearly membership gives you access to <strong className="text-brand-blue">VO₂ Max testing</strong>, <strong className="text-brand-blue">personalized fitness and nutrition plans</strong>, <strong className="text-brand-blue">concierge coaching</strong>, and <strong className="text-brand-blue">luxury adventure retreats</strong> that combine cutting-edge health optimization with active travel. Each health adventure is designed to reset your body, energize your mind, and strengthen your spirit through daily movement, real food, and unforgettable journeys. Perfect for busy families and executives, this is <strong className="text-brand-blue">total lifestyle transformation</strong> — helping you live healthier, longer, and bolder.
              </p>
            </div>
